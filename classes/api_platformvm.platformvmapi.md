[dijets](../README.md) › [API-PlatformVM](../modules/api_platformvm.md) › [PlatformVMAPI](api_platformvm.platformvmapi.md)
...
* [DJTXAssetID](api_platformvm.platformvmapi.md#protected-djtxassetid)
...
* [exportDJTX](api_platformvm.platformvmapi.md#exportdjtx)
* [exportKey](api_platformvm.platformvmapi.md#exportkey)
* [getDJTXAssetID](api_platformvm.platformvmapi.md#getdjtxassetid)
...
* [importDJTX](api_platformvm.platformvmapi.md#importdjtx)
...
* [setDJTXAssetID](api_platformvm.platformvmapi.md#setdjtxassetid)
...
\+ **new PlatformVMAPI**(`core`: [DijetsCore](dijetscore.dijetscore-1.md), `baseURL`: string): *[PlatformVMAPI](api_platformvm.platformvmapi.md)*

*Overrides [JRPCAPI](common_jrpcapi.jrpcapi.md).[constructor](common_jrpcapi.jrpcapi.md#constructor)*

*Defined in [src/apis/platformvm/api.ts:1960](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L1960)*

This class should not be instantiated directly.
Instead use the [Dijets.addAPI](dijets.dijets-1.md#addapi) method.
...
*Defined in [src/apis/platformvm/api.ts:91](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L91)*
...
*Defined in [src/apis/platformvm/api.ts:89](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L89)*
...
*Defined in [src/apis/platformvm/api.ts:87](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L87)*
...
*Defined in [src/apis/platformvm/api.ts:95](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L95)*
...
*Defined in [src/apis/platformvm/api.ts:99](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L99)*
...
*Defined in [src/apis/platformvm/api.ts:97](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L97)*
...
*Defined in [src/apis/platformvm/api.ts:93](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L93)*
...
*Defined in [src/apis/platformvm/api.ts:720](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L720)*
...
`stakeAmount` | BN | The amount of nDJTX the delegator is staking as a [BN](https://github.com/indutny/bn.js/) |
`rewardAddress` | string | The address of the account the staked DJTX and validation reward (if applicable) are sent to at endTime  |
...
*Defined in [src/apis/platformvm/api.ts:676](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L676)*
...
*Defined in [src/apis/platformvm/api.ts:634](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L634)*
...
`startTime` | Date | - | Javascript Date object for the start time to validate |
`endTime` | Date | - | Javascript Date object for the end time to validate |
`stakeAmount` | BN | - | The amount of nDJTX the validator is staking as a [BN](https://github.com/indutny/bn.js/) |
...
*Defined in [src/apis/platformvm/api.ts:182](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L182)*
...
*Defined in [src/apis/platformvm/api.ts:1591](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L1591)*
...
`fromAddresses` | string[] | - | An array of addresses as [Buffer](https://github.com/feross/buffer) who own the staking UTXOs the fees in DJTX |
...
`endTime` | BN | - | The Unix time when the validator stops validating the Primary Network (and staked DJTX is returned). |
...
*Defined in [src/apis/platformvm/api.ts:1511](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L1511)*
...
------ | ------ | ------ | ------ |
`utxoset` | [UTXOSet](api_platformvm_utxos.utxoset.md) | - | A set of UTXOs that the transaction is built on. |
`fromAddresses` | string[] | - | An array of addresses as [Buffer](https://github.com/feross/buffer) who pays the fees in DJTX |
`changeAddresses` | string[] | - | An array of addresses as [Buffer](https://github.com/feross/buffer) who gets the change leftover from the fee payment |
`nodeID` | string | - | The node ID of the validator being added. |
`startTime` | BN | - | The Unix time when the validator starts validating the Primary Network. |
`endTime` | BN | - | The Unix time when the validator stops validating the Primary Network (and staked DJTX is returned). |
...
*Defined in [src/apis/platformvm/api.ts:1693](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L1693)*
...
*Defined in [src/apis/platformvm/api.ts:1867](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L1867)*
...
*Defined in [src/apis/platformvm/api.ts:1799](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L1799)*
...
*Defined in [src/apis/platformvm/api.ts:1405](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L1405)*
...
*Defined in [src/apis/platformvm/api.ts:1313](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L1313)*
...
*Defined in [src/apis/platformvm/api.ts:343](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L343)*
...
*Defined in [src/apis/platformvm/api.ts:464](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L464)*
...
*Defined in [src/apis/platformvm/api.ts:384](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L384)*
...
*Defined in [src/apis/platformvm/api.ts:757](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L757)*
...
▸ **exportDJTX**(`username`: string, `password`: string, `amount`: BN, `to`: string): *Promise‹string | [ErrorResponseObject](../interfaces/src_utils.errorresponseobject.md)›*

*Defined in [src/apis/platformvm/api.ts:847](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L847)*
...
`password` | string | The password of the Keystore user |
`amount` | BN | Amount of DJTX to export as a [BN](https://github.com/indutny/bn.js/)  |
`to` | string | The address on the X-Chain to send the DJTX to. Do not include X- in the address |

**Returns:** *Promise‹string | [ErrorResponseObject](../interfaces/src_utils.errorresponseobject.md)›*

Promise for an unsigned transaction to be signed by the account the the DJTX is
...
*Defined in [src/apis/platformvm/api.ts:1120](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L1120)*
...
*Defined in [src/apis/platformvm/api.ts:202](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L202)*
...
*Defined in [src/apis/platformvm/api.ts:486](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L486)*
...
*Defined in [src/apis/platformvm/api.ts:106](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L106)*
...
*Defined in [src/apis/platformvm/api.ts:141](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L141)*
...
*Defined in [src/apis/platformvm/api.ts:420](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L420)*
...
*Defined in [src/apis/platformvm/api.ts:826](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L826)*
...
*Defined in [src/apis/platformvm/api.ts:265](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L265)*
...
*Defined in [src/apis/platformvm/api.ts:252](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L252)*
...
*Defined in [src/apis/platformvm/api.ts:296](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L296)*
...
*Defined in [src/apis/platformvm/api.ts:941](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L941)*
...
*Defined in [src/apis/platformvm/api.ts:536](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L536)*
...
Promise for an array of validators that are currently staking, see: [platform.getCurrentValidators documentation](https://docs.djtx.network/v1.0/en/api/platform/#platformgetcurrentvalidators).
...
*Defined in [src/apis/platformvm/api.ts:285](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L285)*
...
*Defined in [src/apis/platformvm/api.ts:229](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L229)*
...
*Defined in [src/apis/platformvm/api.ts:951](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L951)*
...
*Defined in [src/apis/platformvm/api.ts:1008](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L1008)*
...
*Defined in [src/apis/platformvm/api.ts:963](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L963)*
...
*Defined in [src/apis/platformvm/api.ts:566](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L566)*
...
Promise for an array of validators that are pending staking, see: [platform.getPendingValidators documentation](https://docs.djtx.network/v1.0/en/api/platform/#platformgetpendingvalidators).
...
*Defined in [src/apis/platformvm/api.ts:1998](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L1998)*
...
*Defined in [src/apis/platformvm/api.ts:1060](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L1060)*
...
*Defined in [src/apis/platformvm/api.ts:364](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L364)*
...
*Defined in [src/apis/platformvm/api.ts:1099](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L1099)*
...
*Defined in [src/apis/platformvm/api.ts:1988](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L1988)*
...
*Defined in [src/apis/platformvm/api.ts:992](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L992)*
...
*Defined in [src/apis/platformvm/api.ts:1176](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L1176)*
...
*Defined in [src/apis/platformvm/api.ts:240](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L240)*
...
*Defined in [src/apis/platformvm/api.ts:1201](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L1201)*
...
*Defined in [src/apis/platformvm/api.ts:1232](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L1232)*
...
*Defined in [src/apis/platformvm/api.ts:439](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L439)*
...
▸ **importDJTX**(`username`: string, `password`: string, `to`: string, `sourceChain`: string): *Promise‹string | [ErrorResponseObject](../interfaces/src_utils.errorresponseobject.md)›*

*Defined in [src/apis/platformvm/api.ts:883](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L883)*
...
`username` | string | The Keystore user that controls the account specified in `to` |
`password` | string | The password of the Keystore user |
`to` | string | The ID of the account the DJTX is sent to. This must be the same as the to argument in the corresponding call to the X-Chain’s exportDJTX |
...
*Defined in [src/apis/platformvm/api.ts:1148](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L1148)*
...
*Defined in [src/apis/platformvm/api.ts:911](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L911)*
...
*Defined in [src/apis/platformvm/api.ts:317](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L317)*
...
*Defined in [src/apis/platformvm/api.ts:511](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L511)*
...
*Defined in [src/apis/platformvm/api.ts:171](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L171)*
...
*Defined in [src/apis/platformvm/api.ts:150](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L150)*
...
*Defined in [src/apis/platformvm/api.ts:596](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L596)*
...
*Defined in [src/apis/platformvm/api.ts:217](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L217)*
...
*Defined in [src/apis/platformvm/api.ts:130](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L130)*
...
*Defined in [src/apis/platformvm/api.ts:308](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L308)*
...
*Defined in [src/apis/platformvm/api.ts:1045](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L1045)*
...
*Defined in [src/apis/platformvm/api.ts:276](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L276)*
...
*Defined in [src/apis/platformvm/api.ts:786](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L786)*
...
*Defined in [src/apis/platformvm/api.ts:805](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/api.ts#L805)*
...
Name | Type | Description |
------ | ------ | ------ |
`subnetID` | Buffer &#124; string | Either a [Buffer](https://github.com/feross/buffer) or an DJTX serialized string for the SubnetID or its alias.  |
