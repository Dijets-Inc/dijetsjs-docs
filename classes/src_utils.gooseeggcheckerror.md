[dijets](../README.md) › [src/utils](../modules/src_utils.md) › [GooseEggCheckError](src_utils.gooseeggcheckerror.md)
...
*Defined in [src/utils/errors.ts:67](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/utils/errors.ts#L67)*
