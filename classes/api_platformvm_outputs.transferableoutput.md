[dijets](../README.md) › [API-PlatformVM-Outputs](../modules/api_platformvm_outputs.md) › [TransferableOutput](api_platformvm_outputs.transferableoutput.md)
...
*Defined in [src/common/output.ts:486](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/common/output.ts#L486)*
...
*Defined in [src/apis/platformvm/outputs.ts:44](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/outputs.ts#L44)*
...
*Defined in [src/apis/platformvm/outputs.ts:43](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/outputs.ts#L43)*
...
*Defined in [src/common/output.ts:475](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/common/output.ts#L475)*
...
*Defined in [src/common/output.ts:411](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/common/output.ts#L411)*
...
*Defined in [src/apis/platformvm/outputs.ts:48](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/outputs.ts#L48)*
...
*Defined in [src/apis/platformvm/outputs.ts:54](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/platformvm/outputs.ts#L54)*
...
*Defined in [src/common/output.ts:477](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/common/output.ts#L477)*
...
*Defined in [src/common/output.ts:427](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/common/output.ts#L427)*
...
*Defined in [src/common/output.ts:457](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/common/output.ts#L457)*
...
*Defined in [src/common/output.ts:482](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/common/output.ts#L482)*
...
*Defined in [src/common/output.ts:416](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/common/output.ts#L416)*
