[dijets](../README.md) › [src/utils](../modules/src_utils.md) › [NoAtomicUTXOsError](src_utils.noatomicutxoserror.md)
...
*Defined in [src/utils/errors.ts:81](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/utils/errors.ts#L81)*
