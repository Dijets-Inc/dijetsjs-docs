[dijets](../README.md) › [API-EVM](../modules/api_evm.md) › [EVMAPI](api_evm.evmapi.md)
...
* [DJTXAssetID](api_evm.evmapi.md#protected-djtxassetid)
...
* [exportDJTX](api_evm.evmapi.md#exportdjtx)
* [exportKey](api_evm.evmapi.md#exportkey)
* [getDJTXAssetID](api_evm.evmapi.md#getdjtxassetid)
...
* [importDJTX](api_evm.evmapi.md#importdjtx)
...
* [setDJTXAssetID](api_evm.evmapi.md#setdjtxassetid)
...
\+ **new EVMAPI**(`core`: [DijetsCore](dijetscore.dijetscore-1.md), `baseURL`: string, `blockchainID`: string): *[EVMAPI](api_evm.evmapi.md)*

*Overrides [JRPCAPI](common_jrpcapi.jrpcapi.md).[constructor](common_jrpcapi.jrpcapi.md#constructor)*

*Defined in [src/apis/evm/api.ts:860](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/evm/api.ts#L860)*
...
`baseURL` | string | "/ext/bc/C/djtx" | Defaults to the string "/ext/bc/C/djtx" as the path to blockchain's baseURL |
...
*Defined in [src/apis/evm/api.ts:66](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/evm/api.ts#L66)*
...
*Defined in [src/apis/evm/api.ts:65](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/evm/api.ts#L65)*
...
*Defined in [src/apis/evm/api.ts:64](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/evm/api.ts#L64)*
...
*Defined in [src/apis/evm/api.ts:67](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/evm/api.ts#L67)*
...
*Defined in [src/apis/evm/api.ts:152](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/evm/api.ts#L152)*
...
*Defined in [src/apis/evm/api.ts:699](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/evm/api.ts#L699)*
...
*Defined in [src/apis/evm/api.ts:624](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/evm/api.ts#L624)*
...
*Defined in [src/apis/evm/api.ts:335](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/evm/api.ts#L335)*
...
`to` | string | The account on the X-Chain to send the DJTX to. |
...
*Defined in [src/apis/evm/api.ts:370](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/evm/api.ts#L370)*
...
*Defined in [src/apis/evm/api.ts:592](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/evm/api.ts#L592)*
...
*Defined in [src/apis/evm/api.ts:210](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/evm/api.ts#L210)*
...
*Defined in [src/apis/evm/api.ts:253](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/evm/api.ts#L253)*
...
*Defined in [src/apis/evm/api.ts:172](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/evm/api.ts#L172)*
...
*Defined in [src/apis/evm/api.ts:298](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/evm/api.ts#L298)*
...
*Defined in [src/apis/evm/api.ts:277](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/evm/api.ts#L277)*
...
*Defined in [src/apis/evm/api.ts:893](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/evm/api.ts#L893)*
...
*Defined in [src/apis/evm/api.ts:74](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/evm/api.ts#L74)*
...
*Defined in [src/apis/evm/api.ts:109](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/evm/api.ts#L109)*
...
*Defined in [src/apis/evm/api.ts:237](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/evm/api.ts#L237)*
...
*Defined in [src/apis/evm/api.ts:910](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/evm/api.ts#L910)*
...
*Defined in [src/apis/evm/api.ts:315](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/evm/api.ts#L315)*
...
*Defined in [src/apis/evm/api.ts:402](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/evm/api.ts#L402)*
...
*Defined in [src/apis/evm/api.ts:463](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/evm/api.ts#L463)*
...
*Defined in [src/apis/evm/api.ts:498](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/evm/api.ts#L498)*
...
`username` | string | The Keystore user that controls the account specified in `to` |
`password` | string | The password of the Keystore user |
`to` | string | The address of the account the DJTX is sent to. This must be the same as the to argument in the corresponding call to the X-Chain’s exportDJTX |
...
*Defined in [src/apis/evm/api.ts:528](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/evm/api.ts#L528)*
...
*Defined in [src/apis/evm/api.ts:554](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/evm/api.ts#L554)*
...
*Defined in [src/apis/evm/api.ts:810](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/evm/api.ts#L810)*
...
*Defined in [src/apis/evm/api.ts:816](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/evm/api.ts#L816)*
...
*Defined in [src/apis/evm/api.ts:141](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/evm/api.ts#L141)*
...
*Defined in [src/apis/evm/api.ts:118](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/evm/api.ts#L118)*
...
*Defined in [src/apis/evm/api.ts:225](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/evm/api.ts#L225)*
...
*Defined in [src/apis/evm/api.ts:98](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/evm/api.ts#L98)*
