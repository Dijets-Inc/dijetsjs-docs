[dijets](../README.md) › [API-Health](../modules/api_health.md) › [HealthAPI](api_health.healthapi.md)
...
\+ **new HealthAPI**(`core`: [DijetsCore](dijetscore.dijetscore-1.md), `baseURL`: string): *[HealthAPI](api_health.healthapi.md)*

*Overrides [JRPCAPI](common_jrpcapi.jrpcapi.md).[constructor](common_jrpcapi.jrpcapi.md#constructor)*

*Defined in [src/apis/health/api.ts:25](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/health/api.ts#L25)*
...
*Defined in [src/apis/health/api.ts:22](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/apis/health/api.ts#L22)*
