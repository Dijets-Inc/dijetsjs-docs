...
*Defined in [src/apis/health/api.ts:25](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/apis/health/api.ts#L25)*
...
*Defined in [src/apis/health/api.ts:22](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/apis/health/api.ts#L22)*
