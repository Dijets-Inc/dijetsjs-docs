[dijets](../README.md) › [API-PlatformVM-UTXOs](../modules/api_platformvm_utxos.md) › [UTXOSet](api_platformvm_utxos.utxoset.md)
...
*Defined in [src/apis/platformvm/utxos.ts:143](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/apis/platformvm/utxos.ts#L143)*
...
*Defined in [src/apis/platformvm/utxos.ts:142](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/apis/platformvm/utxos.ts#L142)*
...
*Defined in [src/common/utxos.ts:265](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/common/utxos.ts#L265)*
...
*Defined in [src/common/utxos.ts:264](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/common/utxos.ts#L264)*
...
*Defined in [src/apis/platformvm/utxos.ts:219](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/apis/platformvm/utxos.ts#L219)*
...
*Defined in [src/common/utxos.ts:299](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/common/utxos.ts#L299)*
...
*Defined in [src/common/utxos.ts:337](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/common/utxos.ts#L337)*
...
*Defined in [src/apis/platformvm/utxos.ts:1001](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/apis/platformvm/utxos.ts#L1001)*
...
`djtxAssetID` | Buffer | - | [Buffer](https://github.com/feross/buffer) of the asset ID for DJTX |
...
`stakeAmount` | BN | - | A [BN](https://github.com/indutny/bn.js/) for the amount of stake to be delegated in nDJTX. |
...
*Defined in [src/apis/platformvm/utxos.ts:905](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/apis/platformvm/utxos.ts#L905)*
...
`networkID` | number | DefaultNetworkID | Networkid, [DefaultNetworkID](../modules/utils_constants.md#const-defaultnetworkid) |
`blockchainID` | Buffer | - | Blockchainid, default undefined |
`fromAddresses` | Buffer[] | - | An array of addresses as [Buffer](https://github.com/feross/buffer) who pays the fees in DJTX |
...
*Defined in [src/apis/platformvm/utxos.ts:1120](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/apis/platformvm/utxos.ts#L1120)*
...
*Defined in [src/apis/platformvm/utxos.ts:567](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/apis/platformvm/utxos.ts#L567)*
...
*Defined in [src/apis/platformvm/utxos.ts:1301](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/apis/platformvm/utxos.ts#L1301)*
...
*Defined in [src/apis/platformvm/utxos.ts:1226](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/apis/platformvm/utxos.ts#L1226)*
...
▸ **buildExportTx**(`networkID`: number, `blockchainID`: Buffer, `amount`: BN, `djtxAssetID`: Buffer, `toAddresses`: Buffer[], `fromAddresses`: Buffer[], `changeAddresses`: Buffer[], `destinationChain`: Buffer, `fee`: BN, `feeAssetID`: Buffer, `memo`: Buffer, `asOf`: BN, `locktime`: BN, `threshold`: number): *[UnsignedTx](api_platformvm_transactions.unsignedtx.md)*

*Defined in [src/apis/platformvm/utxos.ts:800](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/apis/platformvm/utxos.ts#L800)*
...
`djtxAssetID` | Buffer | - | [Buffer](https://github.com/feross/buffer) of the asset ID for DJTX |
`toAddresses` | Buffer[] | - | An array of addresses as [Buffer](https://github.com/feross/buffer) who recieves the DJTX |
`fromAddresses` | Buffer[] | - | An array of addresses as [Buffer](https://github.com/feross/buffer) who owns the DJTX |
`changeAddresses` | Buffer[] | undefined | An array of addresses as [Buffer](https://github.com/feross/buffer) who gets the change leftover of the DJTX |
...
*Defined in [src/apis/platformvm/utxos.ts:656](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/apis/platformvm/utxos.ts#L656)*
...
*Defined in [src/apis/platformvm/utxos.ts:212](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/apis/platformvm/utxos.ts#L212)*
...
*Defined in [src/apis/platformvm/utxos.ts:208](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/apis/platformvm/utxos.ts#L208)*
...
*Defined in [src/apis/platformvm/utxos.ts:147](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/apis/platformvm/utxos.ts#L147)*
...
*Defined in [src/common/utxos.ts:620](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/common/utxos.ts#L620)*
...
*Defined in [src/common/utxos.ts:565](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/common/utxos.ts#L565)*
...
*Defined in [src/common/utxos.ts:496](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/common/utxos.ts#L496)*
...
*Defined in [src/common/utxos.ts:439](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/common/utxos.ts#L439)*
...
*Defined in [src/common/utxos.ts:420](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/common/utxos.ts#L420)*
...
*Defined in [src/common/utxos.ts:543](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/common/utxos.ts#L543)*
...
*Defined in [src/common/utxos.ts:508](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/common/utxos.ts#L508)*
...
*Defined in [src/apis/platformvm/utxos.ts:228](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/apis/platformvm/utxos.ts#L228)*
...
▸ **getMinimumSpendable**(`aad`: [AssetAmountDestination](api_platformvm_utxos.assetamountdestination.md), `asOf`: BN, `locktime`: BN, `threshold`: number, `stakeable`: boolean): *[Error](src_utils.dijetserror.md#static-error)*

*Defined in [src/apis/platformvm/utxos.ts:254](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/apis/platformvm/utxos.ts#L254)*
...
**Returns:** *[Error](src_utils.dijetserror.md#static-error)*
...
*Defined in [src/common/utxos.ts:411](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/common/utxos.ts#L411)*
...
*Defined in [src/common/utxos.ts:464](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/common/utxos.ts#L464)*
...
*Defined in [src/common/utxos.ts:274](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/common/utxos.ts#L274)*
...
*Defined in [src/common/utxos.ts:606](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/common/utxos.ts#L606)*
...
*Defined in [src/common/utxos.ts:587](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/common/utxos.ts#L587)*
...
*Defined in [src/common/utxos.ts:670](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/common/utxos.ts#L670)*
...
*Defined in [src/apis/platformvm/utxos.ts:192](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/apis/platformvm/utxos.ts#L192)*
...
*Defined in [src/common/utxos.ts:358](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/common/utxos.ts#L358)*
...
*Defined in [src/common/utxos.ts:393](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/common/utxos.ts#L393)*
...
*Defined in [src/common/utxos.ts:220](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/common/utxos.ts#L220)*
...
*Defined in [src/common/utxos.ts:634](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/common/utxos.ts#L634)*
...
*Defined in [src/common/utxos.ts:650](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/common/utxos.ts#L650)*
