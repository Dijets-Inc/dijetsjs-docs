[dijets](../README.md) › [Common-RESTAPI](../modules/common_restapi.md) › [RESTAPI](common_restapi.restapi.md)
...
\+ **new RESTAPI**(`core`: [DijetsCore](dijetscore.dijetscore-1.md), `baseURL`: string, `contentType`: string, `acceptType`: string): *[RESTAPI](common_restapi.restapi.md)*
...
------ | ------ | ------ | ------ |
`core` | [DijetsCore](dijetscore.dijetscore-1.md) | - | Reference to the Dijets instance using this endpoint |
...
*Defined in [src/common/restapi.ts:33](https://github.com/Dijets-Inc/dijetsjs/blob/ca67b81/src/common/restapi.ts#L33)*
