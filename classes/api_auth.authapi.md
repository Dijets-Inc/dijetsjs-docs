[dijets](../README.md) › [API-Auth](../modules/api_auth.md) › [AuthAPI](api_auth.authapi.md)
...
*Defined in [src/apis/auth/api.ts:89](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/apis/auth/api.ts#L89)*
...
*Defined in [src/apis/auth/api.ts:76](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/apis/auth/api.ts#L76)*
...
*Defined in [src/apis/auth/api.ts:31](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/apis/auth/api.ts#L31)*
...
*Defined in [src/apis/auth/api.ts:56](https://github.com/Dijets-Inc/dijetsjs/blob/master/src/apis/auth/api.ts#L56)*
